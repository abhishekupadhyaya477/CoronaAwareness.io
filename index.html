...
<section class="corono_update container-fluid">
	<div class=" mb-3 ">
		<h3 class="text-center text-uppercase mb-20"> COVID-19 LIVE UPDATES OF THE WORLD</h3>
	</div>

	<div class="table-responsive">
	<table class="table table-border table-striped test-center" id="tbval">
		<tr>
			<th>Country</th>
...
function fetch(){
	...
	function(data){
		...
		for(var i=1;i<(data['Countries'].length);i++){
			...
			tbval.rows[i].cells[3].style.background='#f39f29';
...
$insertquery="INSERT INTO suspectedcases( username, email, phone, symptoms, messege) VALUES ('$username','$email','$mobile','$chk','$msg')";
